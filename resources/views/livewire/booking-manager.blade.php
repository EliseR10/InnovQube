<div>
    ...
    <div class="p-8 mt-5 bg-white shadow rounded-lg flex flex-col items-center">
        <h2 class="text-xl font-semibold text-gray-800 flex mb-4 text-center">Reserve: {{$name}}</h2>

        <div class="booking-form space-y-4 w-full">
