...
class PropertiesTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Properties::create([
            ...
            'image_url' => 'Beach House.jpg', // Using Storage::url() to get the correct path
        ]);
        Properties::create([
            ...
            'image_url' => 'Cottage House.png', // Using Storage::url() to get the correct path
        ]);
        Properties::create([
            ...
            'image_url' => 'luxury apartment.jpg', // Using Storage::url() to get the correct path
        ]);
        Properties::create([
            ...
            'image_url' => 'Villa.jpg', // Using Storage::url() to get the correct path
        ]);
        Properties::create([
            ...
            'image_url' => 'Country House.jpg', // Using Storage::url() to get the correct path
        ]);
    }
}
